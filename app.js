...
var pagecontact = require('./routes/pagecontact');
...
app.get('/page_left_sidebar', pages.page_left_sidebar);
app.get('/page_right_sidebar', pages.page_right_sidebar);
app.get('/page_double_sidebar', pages.page_double_sidebar);
...
app.use('/page_contact',  pagecontact);
//app.use('/blog',  blogs);
